        ...
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="flex gap-2 items-center">
            ...
            <button
              ...
              className="btn-gradient btn-gradient-blue flex items-center gap-1 h-[52px] px-6 rounded-[32px] border border-white hover:opacity-90 transition-opacity w-full max-w-[172px]"
            >
            ...
            <a
              ...
              className="btn-gradient btn-gradient-yellow flex items-center gap-1 h-[52px] px-6 rounded-[32px] border border-white hover:opacity-90 transition-opacity w-full max-w-[172px]"
              style={{
